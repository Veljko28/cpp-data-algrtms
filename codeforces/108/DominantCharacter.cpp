...
void DominantCharacter() {
	...
	while (t--) {
		...
		else if (s.find("aca") != string::npos or s.find("aba") != string::npos) cout << 3 << '\n';
		else if (s.find("abca") != string::npos or s.find("acba") != string::npos) cout << 4 << '\n';
		else if (s.find("abcabca") != string::npos or s.find("acbacba") != string::npos
			or s.find("abbacca") != string::npos or s.find("accabba") != string::npos) cout << 7 << '\n';
		else cout << -1 << '\n';
	}
}	