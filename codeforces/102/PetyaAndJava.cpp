...
void PetyaAndJava() {
	...
	else if (s.length() - a <= 5) {
		int b = stoi(s);
		if (b >= -32768 and b <= 32767) {
			cout << "short";
			return 0;
		}
		else {
	...
	else if (s.length() - a <= 10) {
		ll b = stoll(s);
		if (b >= -2147483648 and b <= 2147483647) {
			cout << "int";
			return 0;
		}
		else {
	...
	else if (s.length() - a <= 20) {
		long double b{ stold(s) };
		if (b >= (long double)(-1*9223372036854775808) and b <= (long double)9223372036854775807) {
			cout << "long";
			return 0;
		}
		else {
