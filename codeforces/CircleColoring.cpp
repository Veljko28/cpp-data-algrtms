...
void solve(){
    ...
    for (int i =0;i<n;i++){
        if (i == n-1){
            if (p.back() != a[i] and p[1] != a[i]) p.push_back(a[i]);
            else if (p.back() != b[i] and p[1] != b[i]) p.push_back(b[i]);
            else if (p.back() != c[i] and p[1] != c[i]) p.push_back(c[i]);
        }
        else {
            if (p.back() != a[i]) p.push_back(a[i]);
            else if (p.back() != b[i]) p.push_back(b[i]);
            else if (p.back() != c[i]) p.push_back(c[i]);
