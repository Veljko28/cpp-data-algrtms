    ...
    do {
        ...
        for (int i =0;i<t.length();i++){
            ...
            switch(m[t[i]]){
                case 'U':
                    o.fi++;
                    if (o.fi >= n or v[o.fi][o.se] == '#') ok = false;
                    break;
                case 'D':
                    o.fi--;
                    if (o.fi < 0 or v[o.fi][o.se] == '#') ok = false;
                    break;
                case 'L':
                    o.se++;
                    if (o.se >= k or v[o.fi][o.se] == '#') ok = false;
                    break;
                case 'R':
                    o.se--;
                    if (o.se < 0 or v[o.fi][o.se] == '#') ok = false;
                    break;
                default: break;
            }
            if (!ok) break;
