...
void FastFoodRestaurant() {
	...
	while (t--) {
		...
		if (a[0] > 0 and a[1] > 0) ans++, a[0]--, a[1]--;
		if (a[1] > 0 and a[2] > 0) ans++, a[1]--, a[2]--;
		if (a[0] > 0 and a[2] > 0) ans++, a[0]--, a[2]--;
		if (a[0] > 0 and a[1] > 0 and a[2] > 0) ans++, a[0]--, a[1]--, a[2]--;
